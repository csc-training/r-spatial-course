...
( major_basins <- sf::st_union(basins) )
plot(major_basins)
...
simplified_st <- sf::st_simplify(major_basins, dTolerance = 10000,
...
# Clips proper
grid_clip <- sf::st_intersection(grid_sf, sf::st_union(basins))
plot(grid_clip, max.plot=2)
grid_clip
```
...
villages <- st_transform(villages, 32648)
...
1. Load Laos' admin areas, and *st_transform* admin to *"+proj=aea +lat_1=13 +lat_2=22"* coordinate system (Albers Equal Area Projection). plot it.
