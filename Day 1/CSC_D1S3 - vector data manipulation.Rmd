...
```{r}
basins <- sf::read_sf("/home/rstudio/r-spatial-course/Data/basins.gpkg", quiet = TRUE)
rivers <- sf::read_sf("/home/rstudio/r-spatial-course/Data/rivers.gpkg", quiet = TRUE)
sf::st_crs(basins)
sf::st_crs(rivers)
...
NOTE 2023: ms_simplify() from 'rmapshaper' does not currently work, results in error.
It will likely be soon fixed.
...
1. Load districts (KaupunginosajakoPolygon.shp), and *st_transform* admin to *"EPSG:3067"* coordinate system. ggplot it.
