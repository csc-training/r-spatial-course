...
for (package in c("tidyverse", "sf", "raster", "rmapshaper", "spdep", "spatstat",  "mapview", "fpc", "GWmodel", "NbClust", "reshape2", "mapedit", "osmdata", "patchwork", "terra", "exactextractr", "fasterize", "readxl")) {
