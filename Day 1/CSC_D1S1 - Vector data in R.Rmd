...
# if you're using your own personal computer, you can use the relative path to load the data: "../data/lao_adm1.shp". When using the CSC notebooks, we need to provide the full path.
