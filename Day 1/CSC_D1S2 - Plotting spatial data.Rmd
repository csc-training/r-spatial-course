...
* *read* in helsinki_buildings.gpkg and kaupunginosajako.gpkg from the data folder
* Create a ggplot which shows the districts and buildings.
* visualize districts as dashed line (*lty = 2*) in the geom_sf() function call.
* give the districs a white or transparent *fill* colour.
* try different *size*  and *color* for the district boundaries.
